...
\begin{equation}
\label{eq:slewrate}
\text{Slew rate} = 2 \pi \cdot f_{maks} \cdot V_{maks} = 2\pi \cdot 44,1\si\kilo\hertz \cdot 1,65\si\volt = 0,46\si[per-mode=symbol]{\volt\per\micro\second}
\end{equation}
...
\section{Opsummering}
I dette afsnit har vi yada yada yada
