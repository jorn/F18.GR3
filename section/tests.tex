\chapter{Test af reverb og echo impulsrespons}
...
På signaloutputtet blev der tilsluttet en load på $XXX\si{k\Omega}$. \todo{Indsæt rigtig værdi på load modstanden}
