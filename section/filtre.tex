...
Hvis den maksimale frekvens i signalet er større end $f_s/2$ og Sahannons samplings theorem derved ikke er overholdt, opstår der aliasing i det samplede signal som ses som det skraverede område i figur \ref{fig:alias}(c).
\\
...
\\
I figur \ref{fig:filter_cheb1_denorm} øverst ses den denormaliserede filterkarakteristik for det valgte filter med en pasbåndsrippel på $0,1 \si{\decibel}$ og en knækfrekvens på $f_c = 18 \si{\kilo\hertz}$ og nederst ses filterets nominerede gruppeløbstid. 
