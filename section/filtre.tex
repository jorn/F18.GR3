...
Aktive filtre opbygges generelt af 2. ordens filtre som seriekobles til den ønskede orden,
i dette tilfælde anvendes et 6. ordens filter så derfor seriekobles 3 filtre. Disse led
eller filtre kaldes bi-quads.
...
Specifikationen og dimensioneringen af filteret blev udført ved hjælp af matlab, det samlede script kan ses i bilage \ref{sec:aafilterspec}.

Ud fra standard notifikationen for en lav pas 2. ordens overføringsfunktion, ligning
\ref{eq:stdnothlp}, kan Q-værdien og $\omega_0$ findes
